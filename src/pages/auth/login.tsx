    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50/50 dark:bg-slate-950 p-4 transition-colors duration-300 relative overflow-hidden isolate">
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Log in to manage your QR codes.</p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-100 dark:border-slate-800 p-8 sm:p-10">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button type="submit" className="w-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 p-4 rounded-2xl font-bold hover:scale-[1.02] transition-transform shadow-xl shadow-gray-900/10 dark:shadow-white/10 flex justify-center items-center gap-2 mt-2">
              Log In <ArrowRight size={18} />
            </button>
          </form>
          <p className="mt-8 text-center text-sm font-medium text-gray-600 dark:text-gray-400">
            Don't have an account? <Link href="/auth/signup" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
